...
//            }
            ...
            out.println("<span class=\"bloque\">ERRORES:</span>");
            for(String item : errores){
                out.println("<span class=\"bloque\">"+item+"</span>");
            }
...
"                        </script>");
            ...
            out.println("<form action=\""+request.getContextPath()+"/registro\" method=\"post\">");
                ...
                if(mapa.get("nombre_ob")[0].length()>0){//Hacemos lo mismo con apellido
